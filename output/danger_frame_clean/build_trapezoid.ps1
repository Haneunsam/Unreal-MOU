...
public static class DangerFrameTrapezoid {
 ...
 static void Base(Graphics g){
  using(var clip=P(14,4,310,4,310,12,304,18,304,26,297,33,297,37,276,60,53,60,33,38,33,33,25,26,25,19,14,10))g.SetClip(clip);
 ...
 public static void Run(string dir){
  for(int mode=0;mode<1;mode++)using(var hi=new Bitmap(2576,576,PixelFormat.Format32bppArgb)){
   ...
   using(var dst=new Bitmap(1288,288,PixelFormat.Format32bppArgb)){
    ...
    string name=mode==0?"T_DangerFrame_Base_Trapezoid.png":mode==1?"T_DangerFrame_Emissive_Clean.png":"DangerFrame_Preview.png";
...
'@
[DangerFrameTrapezoid]::Run($PSScriptRoot)
