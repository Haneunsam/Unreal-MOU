...
void UMainAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	bool bShouldBlockAO = (MainCharacter->bIsDead || MainCharacter->bIsGroggy || MainCharacter->IsStunned() || bIsStunned || bIsHeld || bIsEmoting || bIsPushing || MainCharacter->IsInCustomizationMode());
